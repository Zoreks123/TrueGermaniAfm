...
class AFKMod(loader.Module):
    """Предоставляет сообщение о том, что вы недоступны.Module by @zxc_dfr3ddy"""
    strings = {"name": "AFK",
               "gone": "<b>[Германи]Я стал в АФК</b>🇩🇪",
               "back": "<b>[Ноут германи!]Я больше не АФК🇩🇪</b>",
               "afk": "<b>[Германи] Я сейчас не в сети ( Был в сети {} назад)🇩🇪.</b>",
               "afk_reason": "<b>[@zxc_dfr3ddy]Я сейчас не в сети ( Был в сети {} назад).\nПричина:</b> <i>{}</i>🇩🇪"}
